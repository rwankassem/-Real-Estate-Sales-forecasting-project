# -*- coding: utf-8 -*-
"""Copy of Copy_of_Sales_Forecating_project (5).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1eJQSVkSu9Z3j0SzxKIZP0_vHWufif9hY
...
*  For numeric columns, missing values were filled using --> mean value of each column.
...
r2_score(y_test,model2.predict(x_test_transformed))

def_pred=model2.predict(x_test_transformed)
...
r2_score(y_test,new_model.predict(x_test_transformed))
...
#r2_score(y_test,model2.predict(y_pred))
...
plt.bar(metrics.keys(), metrics.values(), color='#90b4bc')
